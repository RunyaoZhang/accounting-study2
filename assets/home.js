(function(){
 ...
 if(title){
   ...
   overall.innerHTML=`<div><span>21—25 章总进度</span><strong>${totalItems?pct+'%':'尚未开始'}</strong></div><div class="overall-track"><i style="width:${pct}%"></i></div><small>${visited} / ${chapters.length} 章已打开${totalItems?` · ${totalDone} / ${totalItems} 个知识块已掌握`:''}</small><div class="study-tools"><a href="review.html"><b>主动回忆复习</b><span>先判断再看答案，专练最容易混的分界点 →</span></a></div>`;
